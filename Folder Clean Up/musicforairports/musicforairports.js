const SAMPLE_LIBRARY = {
  ...
  // Temporary test code
  // modified to have random intervals
  setInterval(() => playSample('Grand Piano', 'F4'), Math.floor(Math.random() * 50000));
  setInterval(() => playSample('Grand Piano', 'Ab4'), Math.floor(Math.random() * 50000));
  setInterval(() => playSample('Grand Piano', 'C5'),  Math.floor(Math.random() * 50000));
  setInterval(() => playSample('Grand Piano', 'Db5'), Math.floor(Math.random() * 50000));
  setInterval(() => playSample('Grand Piano', 'Eb5'), Math.floor(Math.random() * 50000));
  setInterval(() => playSample('Grand Piano', 'F5'),  Math.floor(Math.random() * 50000));
  setInterval(() => playSample('Grand Piano', 'Ab5'),  Math.floor(Math.random() * 50000));
